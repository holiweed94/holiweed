...
### 10.42
 ...
 - holiweed version shown in title at main menu
...
### 9.21
 ...
 - Added retrocompatibility for mdk3, added option in .holiweedrc file to handle it
...
### 9.11
 ...
 - Options .holiweedrc file now also updated on automatic update keeping user's preferences
...
### 7.01
 ...
 - The existing iptables rules before the launch of holiweed are now restored upon exiting if modified
...
### 6.21
 ...
 - Fixed error executing holiweed after auto-update on some distros
...
### 3.2
 ...
 - Changed version var to holiweed_version for future version check (auto-update feature)
