...
4. If an issue is opened and more info is needed, `holiweed` staff will request it. If there is no answer in 7 days or the OP is not collaborating, the issue will be closed.
5. If the issue is not related to holiweed or the root cause is out of scope, it will be closed. `holiweed` staff is not a helpdesk support service.
6. Try to be sure that your problem is related to holiweed and that is not a driver issue. A good practice is always to try to perform the same operation without using `holiweed` in order to see if the problem or the behavior can be reproduced. In that case, probably the issue should not be created.
7. Don't talk or mention references to other tools. If you want to talk about other similar tools you can do it on their pages/github. `holiweed` issues are to talk about `holiweed`.

## Collaborating Translators

1. Ask ALWAYS before start a translation to add a new language (by mail at [Oscar_Cardenas.1s.h3r3@gmail.com], by Twitter at [@OscarAkaElvis], by [IRC] or [Discord] channel). Contact to the development team in order to know what are you going to do. You'll be informed about how to proceed.
2. Translate the strings located in `language_strings.sh`, the existing strings of _language_strings_handling_messages_ function in `holiweed.sh` and the strings of _missing_dependencies_text_ function in `missing_dependencies.sh` (this last file is in plugins dir).
...
2. Tweak *"holiweed_DEVELOPMENT_MODE"* variable to "true" for faster development skipping intro and initial checks or change *"holiweed_DEBUG_MODE"* variable for verbosity.
3. Respect the **4 width tab indentation**, code style and the **UTF-8 encoding**.
4. Use **LF** (Unix) line break type (not CR or CRLF).
5. Use [Shellcheck] to search for errors and warnings on code. (Thanks [xtonousou] for the tip :wink:). To avoid false positive warnings you must launch shellcheck using `-x` argument to follow source files and from the directory where `holiweed.sh` is. For example: `~# cd /path/to/holiweed && shellcheck -x holiweed.sh`
6. Increase the version numbers in `holiweed.sh`, in [Readme] and in [Changelog] to the new version that the script represents. The versioning scheme we use is *X.YZ*. Where:
...
1. Send MAC of the BSSID and the default PIN to [Oscar_Cardenas.1s.h3r3@gmail.com]. If you are going to push directly into the repository, keep reading the next points and remember about the git workflow policy.
...
2. Report any issues or bugs by Twitter at [@OscarAkaElvis], mail [Oscar_Cardenas.1s.h3r3@gmail.com], on [IRC] or [Discord] channel or submit Github issue requests [Here] reading first the Issue Creation Policy.
...
6. All merges from [Dev] to [Master] are a new `holiweed` release. This merges to [Master] will be performed and reviewed exclusively by [Oscar_Cardenas]/[OscarAkaElvis].
...
<table>
  <tr>
    <td>
      <b>PayPal</b>: <em>Oscar_Cardenas.1s.h3r3&#64;gmail.com</em> <br/>
...
<div align="center">
    <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=7ELM486P7XKKG"><img src="https://raw.githubusercontent.com/Oscar_Cardenas1sh3r3/holiweed/master/imgs/banners/paypal_donate.png" alt="PayPal" title="PayPal"/></a>
    <a href="https://www.buymeacoffee.com/Oscar_Cardenas"><img src="https://raw.githubusercontent.com/Oscar_Cardenas1sh3r3/holiweed/master/imgs/banners/buymeacoffee.png" alt="Buy me a coffee" title="Buy me a coffee"/></a>
</div>
...
<div align="center">
  <table>
    ...
    <tr>
      <td>
        <img src="https://raw.githubusercontent.com/Oscar_Cardenas1sh3r3/holiweed/master/imgs/banners/bitcoin_qr.png" alt="Bitcoin" title="Bitcoin"/>
      </td>
      <td>
        <img src="https://raw.githubusercontent.com/Oscar_Cardenas1sh3r3/holiweed/master/imgs/banners/bitcoincash_qr.png" alt="Bitcoin Cash" title="Bitcoin Cash"/>
      </td>
      <td>
        <img src="https://raw.githubusercontent.com/Oscar_Cardenas1sh3r3/holiweed/master/imgs/banners/dash_qr.png" alt="Dash" title="Dash"/>
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td>
        <img src="https://raw.githubusercontent.com/Oscar_Cardenas1sh3r3/holiweed/master/imgs/banners/ethereum_qr.png" alt="Ethereum" title="Ethereum"/>
      </td>
      <td>
        <img src="https://raw.githubusercontent.com/Oscar_Cardenas1sh3r3/holiweed/master/imgs/banners/litecoin_qr.png" alt="Litecoin" title="Litecoin"/>
      </td>
      <td>
        <img src="https://raw.githubusercontent.com/Oscar_Cardenas1sh3r3/holiweed/master/imgs/banners/zcash_qr.png" alt="ZCash" title="ZCash"/>
      </td>
    </tr>
  </table>
</div>
...
[Here]: https://github.com/Oscar_Cardenas1sh3r3/holiweed/issues/new/choose
[Master]: https://github.com/Oscar_Cardenas1sh3r3/holiweed/tree/master
[Dev]: https://github.com/Oscar_Cardenas1sh3r3/holiweed/tree/dev
[xtonousou]: https://github.com/xtonousou "xT"
[Oscar_Cardenas]: https://github.com/Oscar_Cardenas1sh3r3
[OscarAkaElvis]: https://github.com/OscarAkaElvis
[Wiki Contact Section]: https://github.com/Oscar_Cardenas1sh3r3/holiweed/wiki/Contact
[Wiki Plugins Development Section]: https://github.com/Oscar_Cardenas1sh3r3/holiweed/wiki/Plugins%20Development
[Wiki Plugins Hall of Fame Section]: https://github.com/Oscar_Cardenas1sh3r3/holiweed/wiki/Plugins%20Hall%20of%20Fame
