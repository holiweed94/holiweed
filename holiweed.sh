...
#Author.......: Oscar_Cardenas
#Version......: 11.10
#Usage........: bash holiweed.sh
...
rc_file_name=".holiweedrc"
alternative_rc_file_name="holiweedrc"
...
github_user="Oscar_Cardenas1sh3r3"
github_repository="holiweed"
branch="master"
script_filename="holiweed.sh"
...
mail="Oscar_Cardenas.1s.h3r3@gmail.com"
author="Oscar_Cardenas"
...
#Tmux vars
session_name="holiweed"
tmux_main_window="holiweed-Main"
no_hardcore_exit=0
...
function language_strings_handling_messages() {
	...
	language_strings_try_to_download["ENGLISH"]="holiweed will try to download the language strings file..."
	language_strings_try_to_download["SPANISH"]="holiweed intentará descargar el fichero de traducciones..."
	language_strings_try_to_download["FRENCH"]="holiweed va essayer de télécharger les fichiers de traductions..."
	language_strings_try_to_download["CATALAN"]="holiweed intentarà descarregar el fitxer de traduccions..."
	language_strings_try_to_download["PORTUGUESE"]="O holiweed tentará baixar o arquivo de tradução..."
	language_strings_try_to_download["RUSSIAN"]="holiweed попытается загрузить языковой файл..."
	language_strings_try_to_download["GREEK"]="Το holiweed θα προσπαθήσει να κατεβάσει το αρχείο γλωσσών..."
	language_strings_try_to_download["ITALIAN"]="holiweed cercherá di scaricare il file delle traduzioni..."
	language_strings_try_to_download["POLISH"]="holiweed spróbuje pobrać plik tłumaczeń..."
	language_strings_try_to_download["GERMAN"]="holiweed wird versuchen, die Übersetzungsdatei herunterzuladen..."
	language_strings_try_to_download["TURKISH"]="holiweed çeviri dosyasını indirmeye çalışacak..."
	language_strings_try_to_download["ARABIC"]="سيحاول holiweed تنزيل ملف سلاسل اللغة ..."
	...
	language_strings_first_time["ENGLISH"]="If you are seeing this message after an automatic update, don't be scared! It's probably because holiweed has different file structure since version 6.1. It will be automatically fixed"
	language_strings_first_time["SPANISH"]="Si estás viendo este mensaje tras una actualización automática, ¡no te asustes! probablemente es porque a partir de la versión 6.1 la estructura de ficheros de holiweed ha cambiado. Se reparará automáticamente"
	language_strings_first_time["FRENCH"]="Si vous voyez ce message après une mise à jour automatique ne vous inquiétez pas! A partir de la version 6.1 la structure de fichier d'holiweed a changé. L'ajustement se fera automatiquement"
	language_strings_first_time["CATALAN"]="Si estàs veient aquest missatge després d'una actualització automàtica, no t'espantis! probablement és perquè a partir de la versió 6.1 l'estructura de fitxers de holiweed ha canviat. Es repararà automàticament"
	language_strings_first_time["PORTUGUESE"]="Se você está vendo esta mensagem depois de uma atualização automática, não tenha medo! A partir da versão 6.1 da estrutura de arquivos do holiweed mudou. Isso será corrigido automaticamente"
	language_strings_first_time["RUSSIAN"]="Если вы видите это сообщение после автоматического обновления, не переживайте! Вероятно, это объясняется тем, что, начиная с версии 6.1, holiweed имеет другую структуру файлов. Проблема будет разрешена автоматически"
	language_strings_first_time["GREEK"]="Εάν βλέπετε αυτό το μήνυμα μετά από κάποια αυτόματη ενημέρωση, μην τρομάξετε! Πιθανόν είναι λόγω της διαφορετικής δομής του holiweed μετά από την έκδοση 6.1. Θα επιδιορθωθεί αυτόματα"
	language_strings_first_time["ITALIAN"]="Se stai vedendo questo messaggio dopo un aggiornamento automatico, niente panico! probabilmente è perché a partire dalla versione 6.1 é cambiata la struttura dei file di holiweed. Sarà riparato automaticamente"
	language_strings_first_time["POLISH"]="Jeśli widzisz tę wiadomość po automatycznej aktualizacji, nie obawiaj się! To prawdopodobnie dlatego, że w wersji 6.1 zmieniła się struktura plików holiweed. Naprawi się automatycznie"
	language_strings_first_time["GERMAN"]="Wenn Sie diese Nachricht nach einem automatischen Update sehen, haben Sie keine Angst! Das liegt vermutlich daran, dass ab Version 6.1 die Dateistruktur von holiweed geändert wurde. Es wird automatisch repariert"
	language_strings_first_time["TURKISH"]="Otomatik bir güncellemeden sonra bu mesajı görüyorsanız, korkmayın! muhtemelen 6.1 sürümünden itibaren holiweed dosya yapısı değişmiştir. Otomatik olarak tamir edilecektir"
	language_strings_first_time["ARABIC"]="إذا كنت ترى هذه الرسالة بعد التحديث التلقائي ، فلا تخف! ربما يرجع السبب في ذلك إلى أن holiweed له بنية ملفات مختلفة منذ الإصدار 6.1. سيتم إصلاحه تلقائيًا "

	declare -gA language_strings_exiting
	language_strings_exiting["ENGLISH"]="Exiting holiweed script v${holiweed_version} - See you soon! :)"
	language_strings_exiting["SPANISH"]="Saliendo de holiweed script v${holiweed_version} - Nos vemos pronto! :)"
	language_strings_exiting["FRENCH"]="Fermeture du script holiweed v${holiweed_version} - A bientôt! :)"
	language_strings_exiting["CATALAN"]="Sortint de holiweed script v${holiweed_version} - Ens veiem aviat! :)"
	language_strings_exiting["PORTUGUESE"]="Saindo do script holiweed v${holiweed_version} - Até breve! :)"
	language_strings_exiting["RUSSIAN"]="Выход из скрипта holiweed v${holiweed_version} - До встречи! :)"
	language_strings_exiting["GREEK"]="Κλείσιμο του holiweed v${holiweed_version} - Αντίο :)"
	language_strings_exiting["ITALIAN"]="Uscendo dallo script holiweed v${holiweed_version} - A presto! :)"
	language_strings_exiting["POLISH"]="Wyjście z skryptu holiweed v${holiweed_version} - Do zobaczenia wkrótce! :)"
	language_strings_exiting["GERMAN"]="Sie verlassen holiweed v${holiweed_version} - Bis bald! :)"
	language_strings_exiting["TURKISH"]="holiweed yazılımından çıkış yapılıyor v${holiweed_version} - Yakında görüşürüz! :)"
	language_strings_exiting["ARABIC"]="الخروج من البرنامج holiweed v${holiweed_version}- نراكم قريبًا! :)"
...
function option_toggle() {
	...
	case "${option_var_name}" in
		"holiweed_BASIC_COLORS")
			remap_colors
		;;
		"holiweed_EXTENDED_COLORS")
			initialize_extended_colorized_output
		;;
		"holiweed_5GHZ_ENABLED")
...
function debug_print() {
	...
	if "${holiweed_DEBUG_MODE:-true}"; then
...
function special_text_missed_optional_tool() {
	...
	if ! "${holiweed_DEVELOPMENT_MODE:-false}"; then
...
function get_5ghz_band_info_from_phy_interface() {
	...
	if iw phy "${1}" info 2> /dev/null | grep "5200 MHz" > /dev/null; then
		if "${holiweed_5GHZ_ENABLED:-true}"; then
			return 0
		else
			return 2
		fi
	...
	case ${option_selected} in
		...
		2)
			if "${holiweed_AUTO_UPDATE:-true}"; then
				ask_yesno 457 "no"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "holiweed_AUTO_UPDATE"; then
						echo
		...
		3)
			if "${holiweed_SKIP_INTRO:-true}"; then
				ask_yesno 569 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "holiweed_SKIP_INTRO"; then
						echo
		...
		4)
			if "${holiweed_BASIC_COLORS:-true}"; then
				ask_yesno 558 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "holiweed_BASIC_COLORS"; then
						echo
		...
		5)
			...
			if "${holiweed_EXTENDED_COLORS:-true}"; then
				ask_yesno 462 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "holiweed_EXTENDED_COLORS"; then
						echo
		...
		6)
			if "${holiweed_AUTO_CHANGE_LANGUAGE:-true}"; then
				ask_yesno 469 "no"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "holiweed_AUTO_CHANGE_LANGUAGE"; then
						echo
		...
		7)
			if "${holiweed_SILENT_CHECKS:-true}"; then
				ask_yesno 577 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "holiweed_SILENT_CHECKS"; then
						echo
		...
		8)
			if "${holiweed_PRINT_HINTS:-true}"; then
				ask_yesno 586 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "holiweed_PRINT_HINTS"; then
						echo
		...
		9)
			if "${holiweed_5GHZ_ENABLED:-true}"; then
				ask_yesno 596 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "holiweed_5GHZ_ENABLED"; then
						echo
		...
		10)
			if [ "${holiweed_WINDOWS_HANDLING}" = "xterm" ]; then
				ask_yesno 657 "yes"
				if [ "${yesno}" = "y" ]; then
					sed -ri "s:(holiweed_WINDOWS_HANDLING)=(xterm):\1=tmux:" "${rc_path}" 2> /dev/null
					echo
				...
				ask_yesno 658 "yes"
				if [ "${yesno}" = "y" ]; then
					sed -ri "s:(holiweed_WINDOWS_HANDLING)=(tmux):\1=xterm:" "${rc_path}" 2> /dev/null
					echo
					language_strings "${language}" 620 "yellow"
					language_strings "${language}" 115 "read"
				fi
		...
		12)
			...
			if [ "${yesno}" = "y" ]; then
				if option_toggle "holiweed_PLUGINS_ENABLED" "required_reboot"; then
					echo
					language_strings "${language}" 620 "yellow"
				else
					echo
		...
		13)
			if "${holiweed_FORCE_NETWORK_MANAGER_KILLING:-true}"; then
				ask_yesno 692 "yes"
				if [ "${yesno}" = "y" ]; then
					if option_toggle "holiweed_FORCE_NETWORK_MANAGER_KILLING"; then
						echo
			...
			if [ "${yesno}" = "y" ]; then
				...
				if [ "${language}" = "${current_permanent_language}" ]; then
					...
					if "${holiweed_AUTO_CHANGE_LANGUAGE:-true}"; then
						...
						option_toggle "holiweed_AUTO_CHANGE_LANGUAGE"
					fi
...
function handshake_capture_check() {
	...
	if [ "${holiweed_WINDOWS_HANDLING}" = "tmux" ]; then
...
function set_wep_key_script() {
	...
	cat >&8 <<-EOF
		#!/usr/bin/env bash
		holiweed_WINDOWS_HANDLING="${holiweed_WINDOWS_HANDLING}"
	EOF
	...
	cat >&8 <<-EOF
		...
		function manage_output() {
			...
			case "\${holiweed_WINDOWS_HANDLING}" in
				"tmux")
					local tmux_color
					tmux_color=""
...
function mdk_version_toggle() {
	...
	if [ "${holiweed_MDK_VERSION}" = "mdk3" ]; then
		sed -ri "s:(holiweed_MDK_VERSION)=(mdk3):\1=mdk4:" "${rc_path}" 2> /dev/null
		holiweed_MDK_VERSION="mdk4"
	else
		sed -ri "s:(holiweed_MDK_VERSION)=(mdk4):\1=mdk3:" "${rc_path}" 2> /dev/null
		holiweed_MDK_VERSION="mdk3"
	fi
...
function print_options() {
	...
	if [ "${holiweed_WINDOWS_HANDLING}" = "xterm" ]; then
		if grep -q "holiweed_WINDOWS_HANDLING=tmux" "${rc_path}" 2> /dev/null; then
			reboot_required_text="${reboot_required[${language}]}"
		fi
		language_strings "${language}" 618 "blue"
	else
		if grep -q "holiweed_WINDOWS_HANDLING=xterm" "${rc_path}" 2> /dev/null; then
			reboot_required_text="${reboot_required[${language}]}"
		fi
	...
	reboot_required_text=""
	if "${holiweed_PLUGINS_ENABLED:-true}"; then
		if grep -q "holiweed_PLUGINS_ENABLED=false" "${rc_path}" 2> /dev/null; then
			reboot_required_text="${reboot_required[${language}]}"
		fi
		language_strings "${language}" 653 "blue"
	else
		if grep -q "holiweed_PLUGINS_ENABLED=true" "${rc_path}" 2> /dev/null; then
			reboot_required_text="${reboot_required[${language}]}"
		fi
...
function clean_env_vars() {
	...
	unset holiweed_AUTO_UPDATE holiweed_SKIP_INTRO holiweed_BASIC_COLORS holiweed_EXTENDED_COLORS holiweed_AUTO_CHANGE_LANGUAGE holiweed_SILENT_CHECKS holiweed_PRINT_HINTS holiweed_5GHZ_ENABLED holiweed_FORCE_IPTABLES holiweed_FORCE_NETWORK_MANAGER_KILLING holiweed_MDK_VERSION holiweed_PLUGINS_ENABLED holiweed_DEVELOPMENT_MODE holiweed_DEBUG_MODE holiweed_WINDOWS_HANDLING
}
...
function set_beef_config() {
	...
	{
	echo -e "beef:"
	echo -e "    version: 'holiweed integrated'"
	echo -e "    debug: false"
...
#Rewrite holiweed script in a polymorphic way adding custom beef location to array to get persistence
...
function credits_option() {
	...
	echo
        echo -e "${green_color}                                                            "
        sleep 0.15 && echo -e "                                                                   \                 _______  "
        sleep 0.15 && echo -e "${yellow_color}                                                    ${green_color}   /_      _\ "
        sleep 0.15 && echo -e "${yellow_color}.__           .__  .__                          .___${green_color}  /_        _\ "
        sleep 0.15 && echo -e "${yellow_color}|  |__   ____ |  | |__|_  _  __ ____   ____   __| _/${green_color} // \      / \\\\\ "
        sleep 0.15 && echo -e "${yellow_color}|  |  \ /  _ \|  | |  \ \/ \/ // __ \_/ __ \ / __ | ${green_color} |\__\    /__/|"
        sleep 0.15 && echo -e "${yellow_color}|   Y  (  <_> )  |_|  |\     /\  ___/\  ___// /_/ | ${green_color}  \    ||    /"
        sleep 0.15 && echo -e "${yellow_color}|___|  /\____/|____/__| \/\_/  \___  >\___  >____ | ${green_color}   \        /"
...
function iptables_nftables_detection() {
	...
	if ! "${holiweed_FORCE_IPTABLES:-false}"; then
...
function set_script_paths() {
	...
	plugins_paths=(
					...
					"${user_homedir}.holiweed/${plugins_dir}"
				)
}
...
function update_options_config_file() {
	...
	case "${1}" in
		"getdata")
			readarray -t OPTION_VARS < <(grep "holiweed_" "${rc_path}" 2> /dev/null)
		;;
		"writedata")
			local option_name
			local option_value
...
function check_root_permissions() {
	...
	if [ "${user}" = "root" ]; then
		if ! "${holiweed_SILENT_CHECKS:-false}"; then
			echo
...
function print_intro() {
	...
	echo -e "${yellow_color} https://github.com/holiweed94           _"
sleep 0.15 && echo -e " .__           .__  .__                          | \ "
sleep 0.15 && echo -e " |  |_    ____ |  | | _|_  _  __ ____   ____   __|_/"
sleep 0.15 && echo -e " |  |  \ / __ \|  | |  \ \/ \/ // __ \_/ __ \ / __ |"
sleep 0.15 && echo -e " |   Y  ( <__> )  |_|  |\     /\  ___/\  ___// /_/ |"
sleep 0.15 && echo -e " |___|  /\____/|____/__| \/\_/  \____> \____>______| "
sleep 0.15 && echo -e "      \/  Hack etico. Usalo en tus propias redes. \/ ${normal_color}"
	echo
...
function env_vars_initialization() {
	...
	ordered_options_env_vars=(
									"holiweed_AUTO_UPDATE" #0
									"holiweed_SKIP_INTRO" #1
									"holiweed_BASIC_COLORS" #2
									"holiweed_EXTENDED_COLORS" #3
									"holiweed_AUTO_CHANGE_LANGUAGE" #4
									"holiweed_SILENT_CHECKS" #5
									"holiweed_PRINT_HINTS" #6
									"holiweed_5GHZ_ENABLED" #7
									"holiweed_FORCE_IPTABLES" #8
									"holiweed_FORCE_NETWORK_MANAGER_KILLING" #9
									"holiweed_MDK_VERSION" #10
									"holiweed_PLUGINS_ENABLED" #11
									"holiweed_DEVELOPMENT_MODE" #12
									"holiweed_DEBUG_MODE" #13
									"holiweed_WINDOWS_HANDLING" #14
									)
...
#Detect if holiweed is working inside a docker container
...
function initialize_extended_colorized_output() {
	...
	colorize=""
	if "${holiweed_BASIC_COLORS:-true}" && "${holiweed_EXTENDED_COLORS:-true}"; then
		if hash ccze 2> /dev/null; then
			colorize="| ccze -A"
		fi
	fi
...
#Kill tmux session started by holiweed
...
#Starting point of holiweed script inside newly created tmux session
function start_holiweed_from_tmux() {
...
#Create new tmux session exclusively for holiweed
function create_tmux_session() {
	...
	if [ "${2}" = "true" ]; then
		...
		start_holiweed_from_tmux "normal"
	else
		tmux new-session -d -s "${1}"
		start_holiweed_from_tmux "nested"
	fi
}
...
#shellcheck disable=SC2009
function close_existing_holiweed_tmux_session() {

	debug_print

	if ! check_inside_tmux; then
		eval "kill -9 $(ps --no-headers aux | grep -i 'tmux.*holiweed' | awk '{print $2}' | tr '\n' ' ') > /dev/null 2>&1"
	fi
}
...
function transfer_to_tmux() {
	...
	close_existing_holiweed_tmux_session
...
function validate_plugin_requirements() {
	...
	if [ -n "${plugin_minimum_ag_affected_version}" ]; then
		if compare_floats_greater_than "${plugin_minimum_ag_affected_version}" "${holiweed_version}"; then
			return 1
		fi
	fi

	if [ -n "${plugin_maximum_ag_affected_version}" ]; then
		if compare_floats_greater_than "${holiweed_version}" "${plugin_maximum_ag_affected_version}"; then
			return 1
		fi
	fi
...
#Check for access to holiweed repository
...
function autoupdate_check() {
	...
	if check_repository_access; then
		...
		holiweed_last_version=$(timeout -s SIGTERM 15 curl -L ${urlscript_directlink} 2> /dev/null | grep "holiweed_version=" | head -n 1 | cut -d "\"" -f 2)

		if [ -n "${holiweed_last_version}" ]; then
			version_checked=1
		else
			http_proxy_detect
			if [ "${http_proxy_set}" -eq 1 ]; then

				holiweed_last_version=$(timeout -s SIGTERM 15 curl --proxy "${http_proxy}" -L ${urlscript_directlink} 2> /dev/null | grep "holiweed_version=" | head -n 1 | cut -d "\"" -f 2)
				if [ -n "${holiweed_last_version}" ]; then
					version_checked=1
				else
					language_strings "${language}" 5 "yellow"
		...
		if [ "${version_checked}" -eq 1 ]; then
			if compare_floats_greater_than "${holiweed_last_version}" "${holiweed_version}"; then
...
function main() {
	...
	if ! "${holiweed_DEVELOPMENT_MODE:-false}"; then
		if ! "${holiweed_SKIP_INTRO:-false}"; then
			language_strings "${language}" 86 "title"
